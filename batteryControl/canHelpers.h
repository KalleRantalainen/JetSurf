...
// Initialize and start the TWAI controller at the Daly bus speed.
...
// Send or receive one CAN frame. The caller owns the frame data.
...
// Use CAN to read battery values from the BMSs

// The CAN functions will be implemented here